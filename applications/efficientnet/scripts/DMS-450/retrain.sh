...
--experiment dms_450_retrain_distil --pin-mem --resume output/train/dms_450_retrain_distil/last.pth.tar  \
--pruned output/train/dms_450_prune/last.pth.tar --input-size 3 224 224 --target 0.2924 --teacher timm/efficientnet_b4 --teacher_input_image_size 320
